 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "# import data\n",
    "insurance = pd.read_csv(\"https://raw.githubusercontent.com/JovianML/opendatasets/master/data/medical-charges.csv\")"
   ]
  },
  {
   "cell_type": "markdown",
     ...
     "data": {
      "application/vnd.plotly.v1+json": {
       ...
       "layout": {
        ...
        "title": {
         "text": "Age Distribution of health Insurance Customers"
        },
        "xaxis": {
         "anchor": "y",
         "domain": [
     ...
     "data": {
      "application/vnd.plotly.v1+json": {
       ...
       "data": [
        ...
        {
         "hovertemplate": "<b>OLS trendline</b><br>charges = 267.118 * age + -2085.01<br>R<sup>2</sup>=0.393631<br><br>smoker=no<br>age=%{x}<br>charges=%{y} <b>(trend)</b><extra></extra>",
         "legendgroup": "no",
         "line": {
          "color": "red"
         },
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "We notice an interesting pattern: for each age group, the charges seem to cluster into three distinct layers. This could indicate the presence of different membership categories (such as bronze, silver, and gold), or other factors that create these groupings in charges such as smoking that makes two layers. Additionally, there is a slight increase in charges as age increases. However, this does not explain why there are so many customers aged 18 and 19. One possible reason is that 18 is the minimum eligible age for insurance in this dataset, which is why there are more of them. We need more data and insights."
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Let's examine how gender affects insurance charges. Do men pay more than women?\n",
    "\n"
   ]
  },
  {
     ...
     "data": {
      "application/vnd.plotly.v1+json": {
       ...
       "layout": {
        ...
        "title": {
         "text": "Distribution of charges by gender"
        },
        "xaxis": {
         "anchor": "y",
         "domain": [
